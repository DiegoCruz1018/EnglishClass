<header class="header">
    <div class="header__contenedor">
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto">Octubre 2023</p>
            <p class="header__texto header__texto--modalidad">En Línea - Presencial</p>

            <a href="/registro" class="header__boton">Obtener Curso</a>
        </div>
    </div>
</header>
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href="/workshops-conferencias" class="navegacion__enlace <?php echo pagina_actual('/workshops-conferencias') ? 'navegacion__enlace--actual' : ''; ?>">Clases</a>
