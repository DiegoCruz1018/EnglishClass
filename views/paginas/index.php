...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aos_animacion(); ?> class="resumen__bloque">
            ...
            <p class="resumen__texto">Teachers</p>
        </div>

        <div <?php aos_animacion(); ?> class="resumen__bloque">
            <p class="resumen__texto resumen__texto--numero"><?php echo $conferencias_total; ?></p>
            <p class="resumen__texto">Clases</p>
        </div>

        <div <?php aos_animacion(); ?> class="resumen__bloque">
            <p class="resumen__texto resumen__texto--numero">3</p>
            <p class="resumen__texto">Certificaciones</p>
        </div>
...
<section class="speakers">
    <h2 class="speakers__heading">Teachers</h2>
    <p class="speakers__descripcion">Conoce a nuestros docentes</p>
...
<section class="boletos">
    <h2 class="boletos__heading">Precios</h2>
    <p class="boletos__descripcion">Precios para clases de Ingles</p>

    <div class="boletos__grid">
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;Clase de Ingles /></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$350 semanales</p>
        </div>

        <div <?php aos_animacion(); ?> class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;Clase de Ingles /></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$250 semanales</p>
        </div>

        <div <?php aos_animacion(); ?> class="boleto boleto--gratis">
            <h4 class="boleto__logo">&#60;Clases de Ingles /></h4>
            <p class="boleto__plan">Clase de Prueba</p>
            <p class="boleto__precio">Gratis</p>
        </div>
    </div>
