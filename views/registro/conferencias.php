...
<h2 class="pagina__heading">Elige el horario de tus clases</h2>
<p class="pagina__descripcion">Elige hasta 5 clases para asistir de forma presencial.</p>

<div class="eventos-registro">
    <main class="eventos-registro__listado">
        <h3 class="eventos-registro__heading--conferencias">&lt;Clases /></h3>
        <h4>Clases del Día de hoy</h4>
    ...
    <aside class="registro">
        ...
        <div class="registro__regalo">
            <label for="regalo" class="registro__label">Selecciona una Preparación</label>
            <select id="regalo" class="registro__select">
                <option value="">-- Selecciona la Preparación --</option>
